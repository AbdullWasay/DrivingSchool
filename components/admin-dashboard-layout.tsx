...
export default function AdminDashboardLayout({ children }) {
  ...
  const navItems = [
    {
      name: translations.admin.dashboard,
      path: "/admin/dashboard",
      icon: Home,
    },
    { name: translations.admin.schools, path: "/admin/schools", icon: School },
    { name: translations.admin.users, path: "/admin/users", icon: Users },
  ];
