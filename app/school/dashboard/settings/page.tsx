              ...
              <div className="space-y-6">
                ...
                <div>
                    ...
                    {[1, 2, 3, 4].map((index) => (
                      <div key={index} className="relative group">
                        <div className="border rounded-md overflow-hidden aspect-square flex items-center justify-center bg-muted">
                          <Image
                            src={`https://images.unsplash.com/photo-1449824913935-59a10b8d2000?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=400&q=80&text=Photo ${index}`}
                  ...
                  <p className="text-xs text-muted-foreground mt-2">
                    You can upload up to 10 photos. Recommended size:
                    1200x800px. Max file size: 5MB per photo.
                  </p>
                </div>
              </div>
            </CardContent>
        ...
        <TabsContent value="services" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Select the services your driving school offers
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="flex items-center justify-between border rounded-md p-4">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      handleServiceChange("motorcycleLicense", checked)
                    }
                  />
                </div>
                ...
                <div className="flex items-center justify-between border rounded-md p-4">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      handleServiceChange("truckLicense", checked)
                    }
                  />
                </div>
                ...
                <div className="flex items-center justify-between border rounded-md p-4">
                  <div>
                    <Label
                      htmlFor="automaticTransmission"
                      className="font-medium">
                      Automatic Transmission
                    </Label>
                    <p className="text-sm text-muted-foreground">
                      Lessons with automatic transmission vehicles
                    </p>
                  </div>
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      handleServiceChange("automaticTransmission", checked)
                    }
                  />
                </div>
                ...
                <div className="flex items-center justify-between border rounded-md p-4">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      handleServiceChange("intensiveCourse", checked)
                    }
                  />
                </div>
                ...
                <div className="flex items-center justify-between border rounded-md p-4">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      For people who already have a license
                    </p>
                  </div>
                  <Switch
                    id="refresherCourse"
                    ...
                    onCheckedChange={(checked) =>
                      handleServiceChange("refresherCourse", checked)
                    }
                  />
                </div>
                ...
                <div className="flex items-center justify-between border rounded-md p-4">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Special support for anxious learners
                    </p>
                  </div>
                  <Switch
                    id="anxietySupport"
                    ...
                    onCheckedChange={(checked) =>
                      handleServiceChange("anxietySupport", checked)
                    }
                  />
                </div>
                ...
                <div className="flex items-center justify-between border rounded-md p-4">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Lessons available in other languages
                    </p>
                  </div>
                  <Switch
                    id="foreignLanguages"
                    ...
                    onCheckedChange={(checked) =>
                      handleServiceChange("foreignLanguages", checked)
                    }
                  />
                </div>
                ...
                <div className="flex items-center justify-between border rounded-md p-4">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Digital theory lessons and materials
                    </p>
                  </div>
                  <Switch
                    id="onlineTheory"
                    ...
                    onCheckedChange={(checked) =>
                      handleServiceChange("onlineTheory", checked)
                    }
                  />
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between border-b pb-4">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Display your pricing details on your profile
                    </p>
                  </div>
                  <Switch
                    id="showPricing"
                    ...
                    onCheckedChange={(checked) =>
                      handleVisibilityChange("showPricing", checked)
                    }
                  />
                </div>
                ...
                <div className="flex items-center justify-between border-b pb-4">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Display reviews from your students
                    </p>
                  </div>
                  <Switch
                    id="showReviews"
                    ...
                    onCheckedChange={(checked) =>
                      handleVisibilityChange("showReviews", checked)
                    }
                  />
                </div>
                ...
                <div className="flex items-center justify-between border-b pb-4">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Display information about your instructors
                    </p>
                  </div>
                  <Switch
                    id="showInstructors"
                    ...
                    onCheckedChange={(checked) =>
                      handleVisibilityChange("showInstructors", checked)
                    }
                  />
                </div>
                ...
                <div className="flex items-center justify-between border-b pb-4">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Display information about your training vehicles
                    </p>
                  </div>
                  <Switch
                    id="showVehicles"
                    ...
                    onCheckedChange={(checked) =>
                      handleVisibilityChange("showVehicles", checked)
                    }
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Request to be featured on the Fahrschulfinder homepage
                      (subject to approval)
                    </p>
                  </div>
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      handleVisibilityChange("featuredOnHomepage", checked)
                    }
                  />
                </div>
              </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between border-b pb-4">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked) =>
                        handleNotificationChange("newInquiries", checked)
                      }
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked) =>
                        handleNotificationChange("platformUpdates", checked)
                      }
                    />
                  </div>
                </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                ...
                <Button className="mt-2 bg-rose-500 hover:bg-rose-600">
                  Update Password
                </Button>
              </div>
            </CardContent>
